...
INSERT INTO "dish" (name, description, price, recipe, mass, preparing_time, img_url, type_dish_id, stop_list)
...
INSERT INTO "dish" (name, description, price, recipe, mass, preparing_time, img_url, type_dish_id, stop_list)
VALUES ('Десерт "Радость обезьянки"', 'Сладость из банана, мороженого и молоко порадует и впечатлит Вас.', 200,
...
INSERT INTO "dish" (name, description, price, recipe, mass, preparing_time, img_url, type_dish_id, stop_list)
VALUES ('Тирамису', 'Тирамису — итальянский творожный десерт на основе сыра маскарпоне. ', 300,
...
INSERT INTO "dish" (name, description, price, recipe, mass, preparing_time, img_url, type_dish_id, stop_list)
VALUES ('Курица с картошкой «Праздничная»', 'Домашнее, всемилюбимое блюдо.', 200,
...
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Чеснок', 300, 'Овощ', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Салат Романо', 150, 'Зелень', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Помидор', 2000, 'Овощ', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Пармезан', 1000, 'Сыр', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Куриная грудка', 5000, 'Мясо', 'гр'); /*5*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Хлеб белый', 1000, 'Хлеб', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Масло подсолнечное', 4000, 'Бакалея', 'мл');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Соль поваренная пищевая', 2000, 'Специи', 'гр'); /*8*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Креветки', 2000, 'Рыба и морепродукты', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Оливковое масло', 2000, 'Бакалея', 'мл');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Огурец', 2000, 'Овощ', 'гр'); /*11*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Сметана', 700, 'Молочная продукция', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Перепелиное яйцо', 20, 'Молочная продукция', 'шт');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Укроп', 100, 'Зелень', 'гр'); /*14*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Зеленый лук', 100, 'Зелень', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Икра красная ', 1000, 'Рыба и морепродукты', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Масло сливочное', 1000, 'Молочная продукция', 'гр'); /*17*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Молоко ', 3000, 'Молочная продукция', 'мл');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Банан', 2000, 'Фрукт', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Лимон', 1000, 'Цитрус', 'гр'); /*20*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Шоколадная стружка', 1000, 'Бакалея', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Яйцо куриное', 50, 'Молочная продукция', 'шт');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Маскарпоне ', 1000, 'Сыр', 'гр'); /*23*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Печенье савоярди', 1000, 'Бакалея', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Сахарная пудра', 500, 'Бакалея', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Крепкий кофе', 500, 'Бакалея', 'гр'); /*26*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Кофейный лике', 500, 'Ликер', 'мл');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Какао-порошок', 500, 'Бакалея', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Ноги куринные', 3000, 'Мясо', 'гр'); /*29*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Картофель', 10000, 'Овощ', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Перец черный', 500, 'Специи', 'гр'); /*31*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Майонез', '2000', 'Молочная продукция', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Бекон ', 500, 'Мясо', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Красный сладкий перец', 2000, 'Овощ', 'гр'); /*34*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Морковь ', 5000, 'Овощ', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Пшеничная мука', 5000, 'Бакалея', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Растительное масло', 2000, 'Бакалея', 'мл'); /*37*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Минтай ', 1000, 'Рыба', 'мл');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Шампиньоны ', 1000, 'Овощ', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Лук репчатый', 500, 'Овощ', 'гр'); /*40*/
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Сливки 20%', 2000, 'Молочная продукция', 'мл');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Слабосоленая семга', 2000, 'Рыба и морепродукты', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Батон', 700, 'Хлеб', 'гр');
INSERT INTO ingredient (name, quantity_in_stock, type, unit)
VALUES ('Сливочное мороженое', 2000, 'Мороженое', 'гр');
/*44*/
